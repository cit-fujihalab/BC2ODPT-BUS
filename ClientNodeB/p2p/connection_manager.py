...
LDB_P = "LDB/DB/send/ldb/"
PARAM_P = "LDB/DB/send/ldb/"
ZIP_P = "LDB/DB/send/zip/"

RE_LDB_P = "LDB/DB/accept/ldb/"
RE_PARAM_P = "LDB/DB/accept/ldb/"
RE_ZIP_P = "LDB/DB/accept/zip/"
...
class ConnectionManager:
	...
	def __ws_handle(self, client, server, message):##
		#server.send_message(client, "ack of message: %s" %(message))
